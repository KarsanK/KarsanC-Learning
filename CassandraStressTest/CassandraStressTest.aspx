<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CassandraStressTest.aspx.cs" Inherits="insert" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <title>Cassandra Stress</title>   
...
<header class="clearfix">
  ...
  <asp:Button ID="btnStartTest" runat ="server" text ="Save" CssClass ="btn btn-primary"  OnClick="btnStartTest_Click" />
